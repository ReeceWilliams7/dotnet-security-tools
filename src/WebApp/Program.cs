...
builder.Services.AddSingleton<IClientIdGenerator, GuidClientIdGenerator>();
builder.Services.AddSingleton<IClientSecretGenerator, Base64RngCryptoClientSecretGenerator>();
